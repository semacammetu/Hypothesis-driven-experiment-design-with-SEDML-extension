# HYPOTHESIS-DRIVEN EXPERIMENT DESIGN WITH A HYPOTHESIS EXTENSION TO SED-ML 

Welcome to the Hypothesis-driven Experiment Design with a Hypothesis Extension to SEDML  development page! The repository includes the latest version of the Kepler Workflow that is calling the necessary model transformation, experiment execution and analysis Python code. The main goal of this page is to create an entry point for the experimenters who want to design, execute and analyze their experiments starting from hypotheses.
